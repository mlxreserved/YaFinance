...
data class ExpenseEntity(
    ...
    @ColumnInfo(name = "is_deleted") val isDeleted: Boolean = false, // Удалено
    @ColumnInfo(name = "is_awaiting_dispatch_expense") val isExpenseAwaiting: Boolean = true, // Ожидание отправки на сервер
