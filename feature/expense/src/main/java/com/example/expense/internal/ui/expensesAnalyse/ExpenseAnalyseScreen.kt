...
import com.example.expense.internal.ui.expensesAnalyse.composable.ExpensesAnalyseEmptyScreen
import com.example.expense.internal.ui.expensesAnalyse.composable.ExpensesAnalyseSuccess
...
@Composable
internal fun ExpensesAnalyseScreen(
    isConnected: Boolean,
    viewModelFactory: ViewModelProvider.Factory,
    onLeadIconClick: () -> Unit,
    modifier: Modifier = Modifier,
    analyseViewModel: ExpenseAnalyseViewModel = viewModel(factory = viewModelFactory)
) {
